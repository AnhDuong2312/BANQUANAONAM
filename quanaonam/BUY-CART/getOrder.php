...
if (isset($_GET['user_id']) && !empty($_GET['user_id'])) {
    ...
    $query = "SELECT product_id, product_image, product_name, size, quantity, price FROM order_detail WHERE user_id = ?";
    ...
    if ($stmt) {
        ...
        if (empty($cartItems)) {
            echo json_encode(['success' => true, 'message' => "Bạn chưa mua sản phẩm nào"]);
        } else {
